package com.zhuchudong.library.okHttpUtils.request;

import android.provider.MediaStore;

import com.zhuchudong.library.okHttpUtils.MyException;
...
public class PostStringRequest extends BaseOkHttpRequest {
    ...
    public PostStringRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, String content, MediaType mediaType) {
        ...
        if (this.content == null) {
            MyException.illegalArgument("the content can not be null !");
        }
