package com.zhuchudong.library.wifi;
...
//http://ticktick.blog.51cto.com/823160/1410080?utm_source=tuicool&utm_medium=referral
public class WifiConnector {
    ...
    /*WifiConnector wifiConnector =new WifiConnector(context,new WifiConnectListener() {

			@Override
			public void OnWifiConnectCompleted(boolean isConnected) {
			}
		});
		wifiConnector.connect("OTECH_ESP8266EX", "ESP8266EX", SecurityMode.WPA2);*/
}